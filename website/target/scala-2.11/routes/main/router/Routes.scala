...
class Routes(
  ...
  // @LINE:12
  private[this] lazy val controllers_Application_admin2_route = Route("GET",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Application_admin2_route(params) =>
      call { 
        controllers_Application_admin2_invoker.call(Application_1.admin())
      }
  
    // @LINE:15
    case controllers_Application_authenticate3_route(params) =>
      call { 
        controllers_Application_authenticate3_invoker.call(Application_1.authenticate())
      }
